...
@section('content')
    ...
    @endif
    <h1 dir="rtl" style="text-align: center; margin-top: 10px;">لیست همکاران تحقیقاتی</h1>
    <div class="form-group" >
        {{--<a dir="rtl"  href="{{route('admin.persons.create')}}">{!! Form::submit('افزودن همکار تحقیقاتی ',['class'=>'btn btn-primary col-sm-5'])!!} </a>--}}
        ...
        {{--'dir'=>'rtl',--}}
        {{--'class'=>'form-control',--}}
        {{--'placeholder'=>'یک نام یا شماره ملی وارد نمایید...')) !!}--}}
        ...
        <div id="myModal" class="modal fade" role="dialog">
            <div class="modal-dialog modal-lg" >
                ...
                <div class="modal-content" dir="rtl">
                    ...
                    {!! Form::hidden('tasvir', '', ['tasvir' => 'tasvir']) !!}
                           ...
                           '0'=> 'دکتری', ),null,['class'=>'form-control','readonly']) !!}
                                            ...
                                            <div class="col-xs-2">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::label('tasvir','کدپستی:') !!}
                                                    <input hidden type="text" name="tasvir" id="tasvir">
                                                    <img name="tasvir" style="width:200px;height: 200px" src="" id="photo" >
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-2">
                                                ...
                                                {!! Form::text('projectcategory',null,['class'=>'form-control','readonly']) !!}
...
//alert($("#tasvir").val($(e.relatedTarget).data('tasvir')));
                $("#tasvir").val($(e.relatedTarget).data('tasvir'));

                $('#photo').attr('src','/rca/public/'+$('#tasvir').val());
...
//                $("#letters").val($(e.relatedTarget).data('letters'));
    ...
    {{--<script type="text/javascript" >--}}
    {{--$(function () {--}}
    {{--$('#lettersModal').on("show.bs.modal", function (e) {--}}
    {{--$("#project-id").html($(e.relatedTarget).data('id'));--}}
    {{--$("#myModalLable").html($(e.relatedTarget).data('name'));--}}
    {{--$("#modal-title").html($(e.relatedTarget).data('name'));--}}
    {{--$("#letters").val($(e.relatedTarget).data('letters'));--}}
    {{--});--}}
